...
## שלב 1: (אופציונלי) יצירת Fork ב-GitHub

> **שימו לב**: שלב זה אופציונלי. אפשר לדלג ישירות לשלב 2, ובשלב 3 לייבא ישירות מהמקור.
...
### אפשרות א׳: ייבוא ישיר מ-GitHub (ללא צורך בחשבון GitHub)

1. היכנסו ל-[Vercel Dashboard](https://vercel.com/dashboard)
2. לחצו על **Add New...** ואז **Project**
3. בשדה למעלה **"Enter a Git repository URL to deploy..."** הדביקו:
   ```
   https://github.com/liranfar/shavtzak
   ```
4. לחצו **Continue**
5. Vercel יזהה שזה פרויקט Vite ויגדיר הכל אוטומטית

### אפשרות ב׳: דרך Fork ב-GitHub (למתקדמים)

אם עשיתם Fork בשלב 1 ויש לכם חשבון GitHub:
