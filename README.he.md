...
## שלב 1: הורדת קבצי המערכת

### אפשרות א׳: הורדה ישירה (מומלץ - ללא צורך ב-GitHub)

1. היכנסו לדף הפרויקט: https://github.com/liranfar/shavtzak
2. לחצו על הכפתור הירוק **Code**
3. בחרו **Download ZIP**
4. חלצו (Extract) את קובץ ה-ZIP למחשב שלכם
5. שמרו את התיקייה - תצטרכו אותה בשלב 3

### אפשרות ב׳: דרך GitHub (למתקדמים)

אם יש לכם חשבון GitHub ואתם רוצים לקבל עדכונים עתידיים:
...
### אפשרות א׳: העלאה ישירה (ללא GitHub)

1. היכנסו ל-[Vercel Dashboard](https://vercel.com/dashboard)
2. גררו את תיקיית הפרויקט (שחילצתם בשלב 1) לתוך חלון הדפדפן
   - או: לחצו על **Add New...** > **Project** > **Import Third-Party Git Repository** ובחרו את התיקייה
3. Vercel יזהה שזה פרויקט Vite ויגדיר הכל אוטומטית
4. **לפני הלחיצה על Deploy** - הוסיפו משתני סביבה (ראו למטה)

### אפשרות ב׳: חיבור מ-GitHub

אם עשיתם Fork בשלב 1:

1. היכנסו ל-[Vercel Dashboard](https://vercel.com/dashboard)
2. לחצו על **Add New...** ואז **Project**
3. תחת **Import Git Repository**, מצאו את `shavtzak`
   - אם לא רואים, לחצו על **Adjust GitHub App Permissions**
4. לחצו **Import** ליד הפרויקט

### הגדרת משתני סביבה (חובה לשתי האפשרויות)

בדף **Configure Project** לפני הפריסה:
